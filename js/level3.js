...
///////////////////////////// - PLATFORMS - /////////////////////////////////////
    ...
    var ledge = platforms.create(800, 380, 'ground2');
    ledge.body.immovable = true;

    var ledge = platforms.create(1000, 290, 'ground1');
    ledge.body.immovable = true;

    var ledge = platforms.create(1400, 290, 'ground2');
    ledge.body.immovable = true;

    var ledge = platforms.create(1600, 230, 'ground1');
    ledge.body.immovable = true;

    var ledge = platforms.create(1900, 380, 'ground2');
    ledge.body.immovable = true;

    var ledge = platforms.create(2000, 290, 'ground1');
    ledge.body.immovable = true;

    var ledge = platforms.create(2300, 380, 'ground2');
    ledge.body.immovable = true;

    var ledge = platforms.create(2400, 290, 'ground1');
    ledge.body.immovable = true;

    var ledge = platforms.create(2720, 190, 'ground2');
    ledge.body.immovable = true;

    var ledge = platforms.create(2900, 290, 'ground2');
    ledge.body.immovable = true;
...
///////////////////////////// - PIGS - /////////////////////////////////////
   ...
   pigs = game.add.group();
    pigs.enableBody = true;
        ...
        var pig2 = pigs.create(1135,218,'pig');
            pig2.body.immovable = true;
        var pig2 = pigs.create(1235,218,'pig');
            pig2.body.immovable = true;
        var pig2 = pigs.create(1455,218,'pig');
            pig2.body.immovable = true;
        var pig2 = pigs.create(1835,158,'pig');
            pig2.body.immovable = true;
        var pig2 = pigs.create(2195,218,'pig');
            pig2.body.immovable = true;
        var pig2 = pigs.create(2265,218,'pig');
            pig2.body.immovable = true;
