...
///////////////////////////// - PLATFORMS - /////////////////////////////////////
    ...
    var ledge = platforms.create(500, 380, 'ground1');
    ledge.body.immovable = true;

    var ledge = platforms.create(1000, 290, 'ground1');
    ledge.body.immovable = true;

    var ledge = platforms.create(1400, 180, 'ground2');
    ledge.body.immovable = true;

    var ledge = platforms.create(1700, 250, 'ground1');
    ledge.body.immovable = true;

    var ledge = platforms.create(2100, 290, 'ground1');
    ledge.body.immovable = true;

    var ledge = platforms.create(2400, 290, 'ground2');
    ledge.body.immovable = true;

    var ledge = platforms.create(2700, 290, 'ground2');
    ledge.body.immovable = true;

    var ledge = platforms.create(2900, 380, 'ground1');
    ledge.body.immovable = true;
...
///////////////////////////// - PIGS - /////////////////////////////////////
   ...
   pigs = game.add.group();
    pigs.enableBody = true;
        ...
        var pig2 = pigs.create(1475,108,'pig');
            pig2.body.immovable = true;
        var pig2 = pigs.create(1835,178,'pig');
            pig2.body.immovable = true;
        var pig2 = pigs.create(2465,218,'pig');
            pig2.body.immovable = true;
        var pig2 = pigs.create(3065,308,'pig');
            pig2.body.immovable = true;
